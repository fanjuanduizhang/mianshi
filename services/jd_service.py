...
- requirements: 任职要求数组"""
    ...
    def analyze_match(self, jd_text: str, user_skills: list = None, resume_text: str = "") -> dict:
...
- gap_summary: 差距总结字符串"""
    ...
    def generate_study_plan(self, gap_analysis: dict, target_position: str = "") -> list:
        missing_skills_str = json.dumps(gap_analysis.get('missing_skills', []), ensure_ascii=False) if gap_analysis else "[]"
